...
3. **Cấu hình Project:**
   - **Project Name**: Đặt tên là `khanhnam`
...
4. **Deploy:**
   - Click "Deploy"
   - Vercel sẽ tự động deploy và tạo URL: `https://khanhnam.vercel.app`
...
3. **Deploy:**
   ...
   vercel
   ```
   - Khi được hỏi project name, nhập: `khanhnam`
...
- Tên miền sẽ là: `https://khanhnam.vercel.app`
